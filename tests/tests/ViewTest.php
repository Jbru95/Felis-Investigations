...
class ViewTest extends \PHPUnit_Framework_TestCase
{
	public function test_footer() {
		...
		$this->assertContains('<footer><p>Copyright © 2017 Felis Investigations, Inc. All rights reserved.</p></footer>',$view->footer());
	}
	...
	public function test_head(){
	    ...
	    $this->assertContains('<title>6god</title>',$view->head());
    }
